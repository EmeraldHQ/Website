...
<div
	class="before:from-dominant relative flex flex-col items-center justify-center gap-32 py-44
        text-center before:absolute before:inset-0 before:-z-10 before:max-w-full before:bg-gradient-to-t before:to-transparent before:opacity-20 before:content-['']"
>
	<!-- Middle text -->
	<div class="leading-none">
		<h1
			class="text-dominant xs:text-[12rem] text-9xl font-semibold sm:text-[14rem] md:text-[16rem]"
		>
			{page.status}
		</h1>
		<h2 class="xs:text-7xl text-5xl font-medium md:text-8xl">
	...
	<div class="absolute -z-10 size-full">
		...
		<Mouse3DTilting initialX={20} initialY={-15} intensity={0.05} class="size-24">
			<div
				class="xs:translate-y-80 size-full translate-x-32 translate-y-64
				text-gray-200/75 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-black before:opacity-30 before:blur-lg
				before:content-[''] sm:translate-x-36 sm:translate-y-96 md:translate-x-56 md:translate-y-72 lg:translate-x-72 xl:translate-x-96"
			>
		...
		<div class="flex justify-end">
			<Mouse3DTilting initialX={-20} initialY={20} intensity={0.05} class="size-24">
				<div
					class="xs:-translate-x-28 size-full -translate-y-36 translate-x-20
					text-gray-200/75 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-black before:opacity-30 before:blur-lg
					before:content-[''] sm:-translate-x-40 sm:-translate-y-10 md:translate-y-0 lg:-translate-x-72 xl:-translate-x-96"
				>
			...
			<Mouse3DTilting initialX={-40} initialY={-13} intensity={0.05} class="size-24">
				<div
					class="xs:translate-y-96 size-full -translate-x-40 translate-y-80
					text-gray-200/75 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-black before:opacity-30 before:blur-lg
					before:content-[''] sm:-translate-x-60 sm:translate-y-72 md:translate-y-96 lg:-translate-x-80 xl:-translate-x-96"
				>
